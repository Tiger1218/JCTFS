...
public class User {
    ...
    @Autowired
    private static RecordsManage recordsManage;
    public int ID; 
    boolean isAdmin;
    ...
    public String hashed_passwd;
    public String salt;
    public String email;

    public final ResponseEntity<Result> register() {
        try {
    ...
    public final ResponseEntity<Result> login() {
        try {
            if (username == null) {
    ...
    public static int token_to_id(final String token) {
        try {
    ...
    public final User to_view_copy() {
        sync_with_database();
        User res = this;
    ...
    public final void sync_with_database() {
